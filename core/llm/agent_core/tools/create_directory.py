"""Create Directory tool: schema wraps `llm.tool_catalog.core_tools.CREATE_DIRECTORY`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import CREATE_DIRECTORY as _LEGACY
