"""Rename File tool: schema wraps `llm.tool_catalog.core_tools.RENAME_FILE`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import RENAME_FILE as _LEGACY
