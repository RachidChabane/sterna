"""Read File tool: schema wraps `llm.tool_catalog.core_tools.READ_FILE`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import READ_FILE as _LEGACY
