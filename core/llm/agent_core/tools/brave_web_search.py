"""Brave Web Search tool: schema wraps `llm.tool_catalog.core_tools.BRAVE_WEB_SEARCH`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import BRAVE_WEB_SEARCH as _LEGACY
