"""Edit Plan tool: schema wraps `llm.tool_catalog.core_tools.EDIT_PLAN`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import EDIT_PLAN as _LEGACY
