"""Get Directions tool: schema wraps `llm.tool_catalog.core_tools.GET_DIRECTIONS`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import GET_DIRECTIONS as _LEGACY
