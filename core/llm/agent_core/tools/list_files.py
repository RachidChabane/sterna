"""List Files tool: schema wraps `llm.tool_catalog.core_tools.LIST_FILES`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import LIST_FILES as _LEGACY
