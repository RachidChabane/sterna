"""Plan Implementation tool: schema wraps `llm.tool_catalog.core_tools.PLAN_IMPLEMENTATION`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import PLAN_IMPLEMENTATION as _LEGACY
