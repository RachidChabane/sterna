"""Geocode Address tool: schema wraps `llm.tool_catalog.core_tools.GEOCODE_ADDRESS`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import GEOCODE_ADDRESS as _LEGACY
