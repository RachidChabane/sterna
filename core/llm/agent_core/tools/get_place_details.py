"""Get Place Details tool: schema wraps `llm.tool_catalog.core_tools.GET_PLACE_DETAILS`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import GET_PLACE_DETAILS as _LEGACY
