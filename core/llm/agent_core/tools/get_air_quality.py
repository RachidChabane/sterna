"""Get Air Quality tool: schema wraps `llm.tool_catalog.core_tools.GET_AIR_QUALITY`, execution delegates to the injected legacy invoker."""

from __future__ import annotations

from llm.tool_catalog.core_tools import GET_AIR_QUALITY as _LEGACY
