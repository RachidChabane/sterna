...
class SubscriptionPlan(models.Model):
    ...
    session_limit_usd = models.DecimalField(
        max_digits=10,
        decimal_places=2,
    ...
    chat_weekly_limit_usd = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    voice_room_weekly_limit_usd = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    code_session_weekly_limit_usd = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
...
class UserSubscription(models.Model):
    ...
    custom_weekly_limit_usd = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    custom_session_limit_usd = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    current_period_end = models.BigIntegerField(
        null=True, blank=True,
    ...
    stripe_event_created = models.BigIntegerField(
        null=True, blank=True,
        help_text=(
    ...
    session_window_start = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Start of current session window (3h). Null = no active session."
    )
    weekly_window_start = models.DateTimeField(
        null=True,
        blank=True,
...
class ServicePricing(models.Model):
    ...
    price_per_1m_input_tokens = models.DecimalField(
        max_digits=12,
        decimal_places=6,
        null=True,
        blank=True,
    ...
    price_per_1m_output_tokens = models.DecimalField(
        max_digits=12,
        decimal_places=6,
        null=True,
        blank=True,
    ...
    price_per_1k_chars = models.DecimalField(
        max_digits=10,
        decimal_places=6,
        null=True,
        blank=True,
...
class UsageLog(models.Model):
    ...
    billing_origin = models.CharField(
        max_length=16,
