...
class ConsiglierSession(models.Model):
    ...
    chat_group_data = models.JSONField(
        help_text="Full ChatGroup data for analysis"
    )
    current_model_at_start = models.CharField(
        max_length=255,
...
class ConversationAnalysis(models.Model):
    ...
    avg_cost_per_message = models.DecimalField(
        max_digits=10,
        decimal_places=6,
        null=True,
        blank=True
    ...
    detected_needs = models.JSONField(
        default=dict,
    ...
    recommended_model_from_conversation = models.JSONField(
        default=dict,
        null=True,
        blank=True,
...
class ModelRecommendation(models.Model):
    ...
    # Trade-offs
    tradeoffs = models.JSONField(
        default=dict,
        help_text="Trade-offs vs current model (cost_savings, quality_delta, speed_delta)"
    )

    # Estimated metrics with this model
    estimated_cost_per_message = models.DecimalField(
        max_digits=10,
        decimal_places=6,
        null=True,
        blank=True
    )
    estimated_quality_score = models.FloatField(
        null=True,
        blank=True,
...
class ConsigliereMessage(models.Model):
    ...
    model_icon_slug = models.CharField(
        max_length=255,
        null=True,
        blank=True,
        help_text="Model icon slug from LobeHub"
    )
    model_icon_url = models.CharField(
        max_length=512,
        null=True,
        blank=True,
        help_text="Full URL to model icon"
    )
    provider_icon_slug = models.CharField(
        max_length=255,
        null=True,
        blank=True,
        help_text="Provider icon slug from LobeHub"
    )
    provider_icon_url = models.CharField(
        max_length=512,
        null=True,
        blank=True,
